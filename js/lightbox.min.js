    ...
    images.forEach((img) => {
        ...
        imgContainer.addEventListener('click', function () {
            ...
            if (!lightboxClose.hasEventListener) {
                lightboxClose.addEventListener("click", lightboxExit)
                lightboxClose.hasEventListener = true // custom property to track if the listener was added
            }
            if (!lightboxPrev.hasEventListener) {
                lightboxPrev.addEventListener("click", cyclePrev)
                lightboxPrev.hasEventListener = true // custom property to track if the listener was added
            }
            if (!lightboxNext.hasEventListener) {
                lightboxNext.addEventListener("click", cycleNext)
                lightboxNext.hasEventListener = true // custom property to track if the listener was added
            }
            if (!lightbox.hasEventListener) {
                lightbox.addEventListener("click", lightboxExit)
                lightbox.hasEventListener = true // custom property to track if the listener was added
            }
            ...
            // removeEventListener, as well as reset hasEventListener
            function lightboxExit() {
                    lightboxClose.removeEventListener("click", lightboxExit)
                    ...
                    lightbox.removeEventListener("click", lightboxExit)
