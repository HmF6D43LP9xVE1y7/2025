...
function loadImages() {
    images.forEach((img) => {
        ...
        imgContainer.addEventListener('click', function () {
            ...
            lightboxPrev.addEventListener("click", function () { // BUG: images from previous galleries get listed on cycle, does not happen via arrow key cycle
                cyclePrev();
            });
            lightboxNext.addEventListener("click", function () { // BUG: images from previous galleries get listed on cycle, does not happen via arrow key cycle
                cycleNext();
            });
            function cyclePrev() {
