...
const handleResize = debounce(() => {
    ...
    gridContainers.forEach(container => container.textContent = ''); // Clear contents
    loadImages();
}, 100);
    ...
    images.forEach((img) => {
        ...
        imgContainer.addEventListener('click', function () {
            ...
            const eventListeners = [
                ...
                { element: lbPrev, event: 'click', handler: cyclePrev },
                { element: lbNext, event: 'click', handler: cycleNext },
                { element: lb, event: 'click', handler: lightboxClick }
            ];
            // addEventListener if inexistent
            ...
            let imgSelectionPath = imgSelection.map(selectedImage => `assets/${selectedImage.prj}/${selectedImage.prj}_${selectedImage.src}.jpg`);
